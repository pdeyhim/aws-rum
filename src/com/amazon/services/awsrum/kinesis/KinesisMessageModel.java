...
public class KinesisMessageModel {
     ...
     * 
     */
    @JsonProperty("connectEnd2")
    private Double connectEnd2;
    /**
     * 
     */
    ...
    @JsonProperty("connectEnd2")
    @DynamoDBAttribute
    public void setConnectEnd2(Double connectEnd2) {
        this.connectEnd2 = connectEnd2;
    }
